...
// MARK: - IMPORTANT!! Please change this token to your own FRESH token. Developer tokens expires after 24hrs. Refresh token was not implemented in this sample app.
...
enum AppDependencyConfig {
    static func configure() {
        ...
        DC.shared.register(dependency: .singleInstance(SBWebClient.shared), for: SBWebClientInterface.self)
    }
}
